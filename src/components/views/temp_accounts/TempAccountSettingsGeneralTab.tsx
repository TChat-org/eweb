...
import TempAccountBasicSettings from "./TempAccountBasicSettings";
...
const TempAccountSettingsGeneralTab: React.FC<IProps> = ({ matrixClient: cli, space }) => {
        ...
        <SettingsTab>
            <SettingsSection heading={_t("common|general")}>
                <div>
                    ...
                    {error && <div className="mx_TempAccountRoomView_errorText">{error}</div>}

                    <TempAccountBasicSettings
...
export default TempAccountSettingsGeneralTab;
